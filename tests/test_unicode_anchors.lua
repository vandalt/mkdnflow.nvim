...
T['formatLink_unicode']['Chinese heading anchor generation'] = function()
    ...
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## 中文字符集', nil, 2)]])
...
T['formatLink_unicode']['mixed ASCII and Chinese heading'] = function()
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## Hello 世界', nil, 2)]])
...
T['formatLink_unicode']['Japanese heading'] = function()
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## こんにちは', nil, 2)]])
...
T['formatLink_unicode']['Korean heading'] = function()
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## 안녕하세요', nil, 2)]])
...
T['formatLink_unicode']['Cyrillic heading'] = function()
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## Привет мир', nil, 2)]])
...
T['edge_cases']['underscores preserved'] = function()
    local result = child.lua_get([[require('mkdnflow.links').formatLink('## my_heading_here', nil, 2)]])
